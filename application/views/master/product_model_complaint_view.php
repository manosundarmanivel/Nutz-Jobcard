        ...
        <div style="display: flex; justify-content:space-between; align-items: center;
            ...
            <div class="card-datatable table-responsive p-3">
                <table class="datatables-demo table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php if (!empty($product_model_complaints)) {
                            foreach ($product_model_complaints as $product_model_complaint) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($product_model_complaint['is_default'] == 0) { ?>
                                            <a class="btn btn-info btn-sm" href="<?= base_url('master/editProductmodelcomplaint/'. $product_model_complaint['id']);?>" ><i class="feather icon-edit"></i>&nbsp;Edit </a>
                                            <a class="btn btn-danger btn-sm" href="<?= base_url('master/deleteProductmodelcomplaint/' . $product_model_complaint['id']); ?>"><i class=" feather icon-trash-2"></i>&nbsp;Delete </a>
                                        <?php
                                        } else {
                                            echo ("-");
                                        }
