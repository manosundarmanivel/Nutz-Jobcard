    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            border-bottom-width: 1px;">
                <h6 class="card-header" style="border:none">Outwork Vendor View</h6>
                <div>
                    <a href="<?= base_url('master/jobcard_outwork_add') ?>" class="btn btn-primary mr-3">Add Outwork Vendor</a>
                </div>
            </div>
