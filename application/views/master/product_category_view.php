    ...
    <h4 class="font-weight-bold py-3 mb-0">Product Category</h4>
        ...
        <div style="display: flex; justify-content:space-between; align-items: center;
            ...
            border-bottom-width: 1px;">
                <h6 class="card-header" style="border:none">Product Category View</h6>
                <div>
                    <a href="<?=base_url('master/product_category_add')?>" class="btn btn-primary mr-3">Add Product Category</a> 
                </div>
            </div>
