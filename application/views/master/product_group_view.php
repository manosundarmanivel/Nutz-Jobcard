    ...
    <h4 class="font-weight-bold py-3 mb-0">Product Group</h4>
        ...
        <div style="display: flex; justify-content:space-between; align-items: center;
            ...
            border-bottom-width: 1px;">
                <h6 class="card-header" style="border:none">Product Group</h6>
                <div>
                    <a href="<?=base_url('master/product_group_add')?>" class="btn btn-primary mr-3">Add Product Group</a> 
                </div>
            </div>
                        ...
                        <?php if (!empty($product_groups)) {
                            ...
                            foreach ($product_groups as $product_group) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($product_group['is_default'] == 0) { ?>
                                            <a class="btn btn-info btn-sm" href="<?= base_url('master/editProductgroup/'. $product_group['id']);?>" ><i class="feather icon-edit"></i>&nbsp;Edit </a>
                                            <a class="btn btn-danger btn-sm" href="<?= base_url('master/deleteProductgroup/' . $product_group['id']); ?>"><i class=" feather icon-trash-2"></i>&nbsp;Delete </a>
                                        <?php
                                        } else {
                                            echo ("-");
                                        }
