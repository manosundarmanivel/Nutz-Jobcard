                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3  row"> 
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="col-md-12 col-xl-10">
                                            <input class="form-control" type="time" name="birth_time" placeholder="" required>
                                        </div>
                                    </div> 
                                    <div class="col-lg-6 col-md-12">
                                ...
                                <tbody>
                                    ...
                                    foreach ($customers as $customer) :   ?>
                                        <tr>
                                            ...
                                            <td><?php if($customer->dob){echo $customer->dob;}else{echo "-";} ?></td>   
                                            <td><?php if($customer->birth_time){echo $customer->birth_time;}else{echo "-";} ?></td>   
                                            <td><?php if($customer->appointment_date){echo $customer->appointment_date;}else{echo "-";} ?></td>   
                                            ...
                                            <td><a href="<?= base_url("admin/deleteCustomer/$customer->id") ?>" class="badge bg-danger p-2 align-bottom">Delete</a></td>   
                                        </tr>
                                    <?php $no++; endforeach; ?>
                                </tbody>
                            </table>
