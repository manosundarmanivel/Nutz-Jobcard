...
<!-- Mirrored from html.phoenixcoded.net/empire/bootstrap/default/layouts_light.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Sep 2020 08:11:42 GMT -->
<head>
...
<body>
        ...
        <div class="layout-inner">
            ...
            <div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-white logo-white">
                ...
                <ul class="sidenav-inner py-1">
                    <li class="sidenav-header large font-weight-semibold">Masters</li>
                    <!-- Dashboards -->
                    <li class="sidenav-item open active">
                        ...
                        <ul class="sidenav-menu">
                            <li class="sidenav-item active">
                                <a href="<?= base_url('dashboard/ledger_group_master_add') ?>" class="sidenav-link">
                                    <div>Add</div>
                                </a>
                            </li>
                            <li class="sidenav-item">
                                <a href="<?= base_url('dashboard/ledger_group_master_view')?>" class="sidenav-link">
                                    <div>View</div>
                                </a>
                            </li>
                    ...
                    <li class="sidenav-item open active">
                        ...
                        <ul class="sidenav-menu">
                            <li class="sidenav-item active">
                                <a href="<?= base_url('dashboard/ledger_master_add') ?>" class="sidenav-link">
                                    <div>Add</div>
                                </a>
                            </li>
                            <li class="sidenav-item">
                                <a href="<?= base_url('dashboard/ledger_master_view')?>" class="sidenav-link">
                                    <div>View</div>
                                </a>
                            </li>
    ...
    <script src="<?= base_url('assets') ?>/js/pages/dashboards_index.js"></script>
</body>
