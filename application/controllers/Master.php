...
class Master extends CI_Controller
{
    ...
    public function getLedgerName()
    {
        ...
        $ledgerName = $this->User_model->getLedgerNameByContact($contactNumber);

        if ($ledgerName) {
            $response = ['ledgerName' => $ledgerName];
        } else {
    ...
    public function addJobCard()
    {
        ...
        $job_data = array(
            'formno' => $jobData['formno'],
            'contact' => $jobData['contact'],
            'customerName' => $jobData['customerName'],
            'warrantyStatus' => $jobData['warrantyStatus'],
